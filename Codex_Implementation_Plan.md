...
请优先使用已有 Codex skills，例如 repo-analysis、code-editing、experiment-design、verification-before-completion。如果 skills 不可用，则用 shell、Python、pytest/unittest、markdown 日志完成。
