...
class GaussianModel:
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._opacity], 'lr': training_args.opacity_lr * training_args.srd_opacity_lr_scale, "name": "opacity"},
        ...
        l.extend([
            ...
            {'params': [self._reflection_feature], 'lr': training_args.feature_lr * training_args.srd_reflection_feature_lr_scale, "name": "reflection_feature"},
            {'params': [self._specular_weight], 'lr': training_args.mask_lr * training_args.srd_specular_weight_lr_scale, "name": "specular_weight"},
