...
class AblationSystemContractTest(unittest.TestCase):
    expected_configs = [
        ...
        "full_srd_gs_branch_raster_render_gate_neutral_i300.yaml",
        "full_srd_gs_branch_raster_reflection_freeze_i300.yaml",
        "full_srd_gs_branch_raster_opacity_freeze_i300.yaml",
        "full_srd_gs_branch_raster_opacity_quarter_i300.yaml",
