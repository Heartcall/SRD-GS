...
```bash
python train-NeRF.py -s /data/liuly/dataset/3DGS/NeRF Synthetic/materials --eval --iterations 2 --save_iterations 2 --checkpoint_iterations 2 --test_iterations 2 --model_path output/ref_gs_limitation_timing/materials_iter2_round4
```
