    ...
    return [
        {
            ...
            "dataset_scene": ball,
            "settings": "stock training checkpoint; export gt/pbr_rgb/render/diffuse/specular/albedo/roughness/normal/depth/alpha via export_pbr_views.py --return_components",
        ...
        },
        {
            ...
            "settings": "full model; depth_ratio in {0, 0.5, 1}; depth_trunc/voxel_size sweep with export_mesh.py; evaluate_geometry.py consumes mesh/eval point PLY files",
            ...
            "small_sanity": f"python experiments/ref_gs_limitation_analysis/export_mesh.py --dry-run --source_path '{root}/{toaster}' --model_path output/ref_gs_limitation_sanity/toaster_iter2 --checkpoint output/ref_gs_limitation_sanity/toaster_iter2/chkpnt2.pth --split test --max_views 3 --depth_ratio 1.0 --out_mesh experiments/ref_gs_limitation_analysis/meshes/toaster_sanity/mesh.ply",
            "full_run": f"python train.py -s '{root}/{toaster}' --eval --run_dim 256 --albedo_bias 0 --depth_ratio 0 --checkpoint_iterations 31000 --model_path output/ref_gs_limitation/e2_toaster_depth0 ; python experiments/ref_gs_limitation_analysis/export_mesh.py --source_path '{root}/{toaster}' --model_path output/ref_gs_limitation/e2_toaster_depth0 --checkpoint output/ref_gs_limitation/e2_toaster_depth0/chkpnt31000.pth --split test --max_views 200 --depth_ratio 0 --out_mesh experiments/ref_gs_limitation_analysis/meshes/e2_toaster_depth0/mesh.ply ; python experiments/ref_gs_limitation_analysis/evaluate_geometry.py --pred experiments/ref_gs_limitation_analysis/meshes/e2_toaster_depth0/mesh.ply --gt '{root}/Shiny Blender Synthetic/toaster/toaster_gt_mesh.ply' --out experiments/ref_gs_limitation_analysis/metrics/e2_toaster_depth0_geometry",
        ...
        },
        {
            ...
            "settings": "config-only: run_dim in {64, 256}, gsrgb_loss on/off, roughness_lr in {0, 0.002}, rand_init on/off; no-Sph-Mip/no-factorization still require implementation",
            ...
            "full_run": f"python train-NeRO.py -s '{root}/{glossy}' --eval --run_dim 64 --albedo_bias 2 --albedo_lr 0.0005 --init_until_iter 3000 --checkpoint_iterations 31000 --model_path output/ref_gs_limitation/e3_glossy_rundim64 ; python experiments/ref_gs_limitation_analysis/export_pbr_views.py --source_path '{root}/{glossy}' --model_path output/ref_gs_limitation/e3_glossy_rundim64 --checkpoint output/ref_gs_limitation/e3_glossy_rundim64/chkpnt31000.pth --split test --max_views 64 --return_components --render_func ref --out_dir experiments/ref_gs_limitation_analysis/exports/e3_glossy_rundim64 ; python experiments/ref_gs_limitation_analysis/evaluate_pbr.py --export_dir experiments/ref_gs_limitation_analysis/exports/e3_glossy_rundim64 --out experiments/ref_gs_limitation_analysis/metrics/e3_glossy_rundim64_pbr_eval",
        ...
        },
        {
            ...
            "dataset_scene": nerf,
            "settings": "train-NeRF with gsrgb_loss on/off; run_dim {64, 256}; measure with run_timing_probe.sh; compare to external 2DGS/3DGS baseline if available",
            ...
            "small_sanity": f"bash experiments/ref_gs_limitation_analysis/run_timing_probe.sh --script train-NeRF.py --scene '{root}/{nerf}' --model output/ref_gs_limitation_timing/materials_iter10 --iterations 10 --dry-run",
            "full_run": f"bash experiments/ref_gs_limitation_analysis/run_timing_probe.sh --script train-NeRF.py --scene '{root}/{nerf}' --model output/ref_gs_limitation/e5_materials_rundim64 --iterations 31000 --extra --run_dim --extra 64 --extra --albedo_bias --extra 0 --extra --gsrgb_loss ; python experiments/ref_gs_limitation_analysis/export_pbr_views.py --source_path '{root}/{nerf}' --model_path output/ref_gs_limitation/e5_materials_rundim64 --checkpoint output/ref_gs_limitation/e5_materials_rundim64/chkpnt31000.pth --render_func nerf --split test --max_views 200 --return_components --out_dir experiments/ref_gs_limitation_analysis/exports/e5_materials_rundim64 ; python experiments/ref_gs_limitation_analysis/evaluate_pbr.py --export_dir experiments/ref_gs_limitation_analysis/exports/e5_materials_rundim64 --out experiments/ref_gs_limitation_analysis/metrics/e5_materials_rundim64_pbr_eval",
